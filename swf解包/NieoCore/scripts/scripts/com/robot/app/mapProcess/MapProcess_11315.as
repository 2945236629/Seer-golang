package com.robot.app.mapProcess
{
   ...
   public class MapProcess_11315 extends BaseMapProcess
   {
      
      public function MapProcess_11315()
      {
         super();
      }
      ...
      private function fight() : void
      {
         ...
         FightManager.tryFight(439,[0,0,0,0]);
      }
      
      private function yiQi() : void
      {
         NpcDialog.show(NPC.ANNUO,["谢谢你，小赛尔！这下我的主人再也不用发愁啦！"],["不客气！"],[function():void
         {
            ToolBarController.panel.hide();
            LevelManager.iconLevel.visible = false;
