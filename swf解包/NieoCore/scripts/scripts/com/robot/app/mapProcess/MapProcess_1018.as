package com.robot.app.mapProcess
{
   ...
   public class MapProcess_1018 extends BaseMapProcess
   {
      
      private var btnArray:Array = new Array();
      
      public function MapProcess_1018()
      {
         super();
      }
      ...
      private function onOpen(param1:MouseEvent) : void
      {
         ...
         {
            case 0:
               StatManager.sendStat2014("实验室改造","学习力基地内点击商店",StatManager.USER_CHARACTER);
               ModuleManager.showModule(ClientConfig.getAppModule("SupermarketPanel"),"正在打开...","精灵改造");
               break;
            case 1:
               StatManager.sendStat2014("实验室改造","学习力基地内点击学习力战场",StatManager.USER_CHARACTER);
               ModuleManager.showModule(ClientConfig.getAppModule("TrainingCollectionPanel"));
               break;
            case 2:
               StatManager.sendStat2014("实验室改造","学习力基地内点击精灵一键极品",StatManager.USER_CHARACTER);
