package com.robot.app.mapProcess
{
   ...
   public class MapProcess_10966 extends BaseMapProcess
   {
      ...
      public function MapProcess_10966()
      {
         super();
      }
      ...
      private function clickItem(param1:MouseEvent) : void
      {
         ...
         getDefinitionByName("com.robot.app2.control.ShipModifyController").clickCrater(param1,8,this.updateData);
      }
      ...
      private function updateData(param1:Function = null) : void
      {
         ...
         KTool.getMultiValue([2554],function(param1:Array):void
         {
            ...
            while(_loc3_ < 4)
            {
               _state.push(_loc2_[_loc3_ + 12]);
               _loc4_ += _loc2_[_loc3_ + 12];
               _loc3_++;
            }
            if(_loc4_ == 4)
            {
