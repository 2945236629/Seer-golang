package com.robot.app.mapProcess
{
   ...
   public class MapProcess_102 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         this.j_npc.buttonMode = true;
         this.j_npc.addEventListener(MouseEvent.CLICK,this.onNpcTouch);
         this.pet_mc = conLevel["pet_mc"];
         this.pet_mc.visible = false;
         conLevel["enterFight"].buttonMode = true;
         conLevel["enterFight"].addEventListener(MouseEvent.CLICK,this.onEnterFightTouch);
         conLevel["arenaTouchBtn_1"].buttonMode = true;
         conLevel["arenaTouchBtn_1"].addEventListener(MouseEvent.CLICK,this.onArenaFightTouch);
         conLevel["arenaTouchBtn_2"].buttonMode = true;
         conLevel["arenaTouchBtn_2"].addEventListener(MouseEvent.CLICK,this.onArenaFightTouch);
         conLevel["arenaTouchBtn_3"].buttonMode = true;
         conLevel["arenaTouchBtn_3"].addEventListener(MouseEvent.CLICK,this.onArenaFightTouch);
         this.timer = new Timer(9000);
         this.timer.addEventListener(TimerEvent.TIMER,this.onTimer);
         this.timer.start();
      }

      private function onNpcTouch(param1:MouseEvent) : void
      {
         this.hitNpc();
      }

      private function onEnterFightTouch(param1:MouseEvent) : void
      {
         this.onPetWarHandler();
      }

      private function onArenaFightTouch(param1:MouseEvent) : void
      {
         this.onPetWarHandler();
      }
      ...
      override public function destroy() : void
      {
         ...
         this.j_npc.removeEventListener(MouseEvent.CLICK,this.onNpcTouch);
         conLevel["enterFight"].removeEventListener(MouseEvent.CLICK,this.onEnterFightTouch);
         conLevel["arenaTouchBtn_1"].removeEventListener(MouseEvent.CLICK,this.onArenaFightTouch);
         conLevel["arenaTouchBtn_2"].removeEventListener(MouseEvent.CLICK,this.onArenaFightTouch);
         conLevel["arenaTouchBtn_3"].removeEventListener(MouseEvent.CLICK,this.onArenaFightTouch);
