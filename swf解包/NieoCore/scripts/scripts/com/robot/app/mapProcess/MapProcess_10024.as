package com.robot.app.mapProcess
{
   ...
   public class MapProcess_10024 extends BaseMapProcess
   {
      ...
      public function MapProcess_10024()
      {
         super();
      }
      ...
      private function onFightDululuClose(param1:PetFightEvent) : void
      {
         ...
         FightDispatcher.removeEventListener(PetFightEvent.FIGHT_CLOSE,this.onFightDululuClose);
