package com.robot.app.mapProcess
{
   ...
   public class MapProcess_11784 extends BaseMapProcess
   {
      ...
      public function MapProcess_11784()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         MainManager.actorInfo.mapID = 11784;
         this.initPos = new Point(428,125);
      ...
      public function update(param1:* = null) : void
      {
         ...
         KTool.getMultiValue([10579,10581,10584,10582,10583],function(param1:Array):void
         {
            ...
            while(_loc2_ <= 30)
            {
               ...
               {
                  depthLevel["box_" + (_loc2_ - 25)].visible = false;
               }
               _loc2_++;
            }
