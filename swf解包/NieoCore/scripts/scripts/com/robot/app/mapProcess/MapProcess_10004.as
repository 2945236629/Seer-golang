package com.robot.app.mapProcess
{
   ...
   public class MapProcess_10004 extends BaseMapProcess
   {
      ...
      public function MapProcess_10004()
      {
         super();
      }
      ...
      private static function onJoinHandler(param1:SocketEvent) : void
      {
         ...
         MapManager.changeLocalMap(10003);
      }
      ...
      public function gotoNextHoleHit() : void
      {
         ...
         SocketConnection.send(CommandID.MYSTERYHOLE_JOIN,int(10003 - 10000));
      }
