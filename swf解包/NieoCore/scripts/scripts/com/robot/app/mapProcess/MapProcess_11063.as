package com.robot.app.mapProcess
{
   ...
   public class MapProcess_11063 extends BaseMapProcess
   {
      ...
      public function MapProcess_11063()
      {
         super();
      }
      ...
      {
         KTool.getMultiValue([12415],function(param1:Array):void
         {
            if(param1[0] < 10)
            {
               if(!_exploitPorBar)
               {
                  exploitNow();
                  StatManager.sendStat2014("0129全民打造龙王之冠","点击收集天赐水晶","2016运营活动");
               }
            }
            else
            {
