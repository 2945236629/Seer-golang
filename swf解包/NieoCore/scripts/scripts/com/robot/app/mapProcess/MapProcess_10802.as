package com.robot.app.mapProcess
{
   ...
   public class MapProcess_10802 extends BaseMapProcess
   {
      
      public function MapProcess_10802()
      {
         super();
      }
      ...
      {
         super.setup();
         if(!BitBuffSetClass.getState(22640))
         {
            ResourceManager.getResource(ClientConfig.getMapAnimate("map_10802_0"),function(param1:MovieClip):void
            {
               var taskMC:MovieClip = param1;
               BitBuffSetClass.setState(22640,1);
      ...
      {
         CommonUI.addYellowExcal(btnLevel,318,200);
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         {
            ModuleManager.showModule(ClientConfig.getAppModule("MengPetAllianceQingLongPanel"));
         }
      }
