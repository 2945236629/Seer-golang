package com.robot.app.mapProcess
{
   ...
   public class MapProcess_10388 extends BaseMapProcess
   {
      
      public function MapProcess_10388()
      {
         super();
      }
      ...
      public function onEnterMap() : void
      {
         ...
         TrainDoorController.getInstance()._curtGameTpye = 0;
         MapManager.changeLocalMap(10389);
      }
   }
}
