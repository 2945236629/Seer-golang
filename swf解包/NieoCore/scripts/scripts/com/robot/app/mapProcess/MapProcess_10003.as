package com.robot.app.mapProcess
{
   ...
   public class MapProcess_10003 extends BaseMapProcess
   {
      ...
      public function MapProcess_10003()
      {
         super();
      }
      ...
      private static function onJoinHandler(param1:SocketEvent) : void
      {
         ...
         MapManager.changeLocalMap(10004);
      }
      ...
      public function gotoNextHoleHit() : void
      {
         ...
         SocketConnection.send(CommandID.MYSTERYHOLE_JOIN,int(10004 - 10000));
      }
