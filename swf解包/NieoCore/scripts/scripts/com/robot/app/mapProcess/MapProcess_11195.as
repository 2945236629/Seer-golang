package com.robot.app.mapProcess
{
   ...
   public class MapProcess_11195 extends BaseMapProcess
   {
      
      public function MapProcess_11195()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         {
            conLevel["boss"].visible = param1[0] == 2 && KTool.getBit(param1[1],4) == 0;
      ...
      {
         NpcDialog.show(NPC.JIAQIU,["想要挑战洛亚之灵，必须先通过我的考验。如果你能击败我，将会获得两次挑战洛亚之灵的机会，但我次日才会再次出现！"],["得罪了，守护者！","看我用钻石砸晕你！","我需要再磨砺一下。"],[this.fight,this.diamond,null]);
      }
      ...
      private function fight() : void
      {
         ...
         FightManager.fightNoMapBoss("伽丘",6786);
      }
      ...
      private function diamond() : void
      {
         ...
         {
            SocketConnection.sendByQueue(47284,[2,4],function():void
            {
