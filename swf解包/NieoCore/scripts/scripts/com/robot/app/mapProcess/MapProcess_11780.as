package com.robot.app.mapProcess
{
   ...
   public class MapProcess_11780 extends BaseMapProcess
   {
      ...
      public function MapProcess_11780()
      {
         super();
      }
      ...
      override protected function init() : void
      {
         ...
         MainManager.actorInfo.mapID = 11780;
         this.initPos = new Point(500,430);
      ...
      public function update(param1:* = null) : void
      {
         ...
         KTool.getMultiValue([10579,10581,10584,10582,10583],function(param1:Array):void
         {
            ...
            while(_loc2_ <= 10)
            {
               ...
               {
                  depthLevel["box_" + (_loc2_ - 5)].visible = false;
               }
               _loc2_++;
            }
