package com.robot.app.mapProcess
{
   ...
   public class MapProcess_11317 extends BaseMapProcess
   {
      
      public function MapProcess_11317()
      {
         super();
      }
      ...
      private function fight() : void
      {
         ...
         FightManager.tryFight(441,[0,0,0,0]);
      }
      
      private function yiQi() : void
      {
         NpcDialog.show(NPC.YI_BU,["谢谢你，小赛尔！这下我的主人再也不用发愁啦！"],["不客气！"],[function():void
         {
            ToolBarController.panel.hide();
            LevelManager.iconLevel.visible = false;
