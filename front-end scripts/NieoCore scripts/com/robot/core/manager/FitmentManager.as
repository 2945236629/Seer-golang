package com.robot.core.manager
{
   ...
   public class FitmentManager
   {
      ...
      public static function saveInfo() : void
      {
         ...
         _loc3_.writeUnsignedInt(roomID);
         ...
         SocketConnection.send(CommandID.SET_FITMENT,_loc3_);
      }
      ...
      public static function getUsedInfo(param1:uint) : void
      {
         ...
         SocketConnection.addCmdListener(CommandID.FITMENT_USERING,function(param1:SocketEvent):void
         {
            ...
            userID = _loc6_.readUnsignedInt();
            roomID = _loc6_.readUnsignedInt();
            var _loc7_:uint = _loc6_.readUnsignedInt();
            var _loc8_:int = 0;
            while(_loc8_ < _loc7_)
            {
               _loc3_ = new FitmentInfo();
         ...
         SocketConnection.addCmdListener(CommandID.FITMENT_ALL,function(param1:SocketEvent):void
         {
            ...
            if(_simpleProtocol)
            {
               ...
               while(_loc8_ < _loc5_)
               {
                  ...
                  {
                     _loc4_[_loc7_] = int(_loc4_[_loc7_]) + 1;
                  }
                  _loc8_++;
               }
